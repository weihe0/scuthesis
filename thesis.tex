...
\documentclass[adobefonts,cs4size,fancyhdr,fntef]{ctexrep}
\usepackage{amsmath,amssymb,algorithm,algorithmic,booktabs,graphicx,paralist,supertabular}
\graphicspath{{scu/}} %设置插图目录
...
\CTEXsetup[format={\zihao{-4}\kaishu\flushleft}]{subsection}
...
\newcommand{\thesistitle}{电流表读数识别的算法与实现} %论文标题
